...
public class test_P2_13_Wtuoweichengsuoyouchaweituo {
	 ...
	 * 4、类型字段显示买入转让，数量字段为委托数量（卖可转数量），价格显示委托价格，状态显示已委托，剩余为委托数量；
	 * 5、委托时间显示下单时间；
	 */
	@Test
	public void testWtuoweichengsuoyouchaweituo() {
