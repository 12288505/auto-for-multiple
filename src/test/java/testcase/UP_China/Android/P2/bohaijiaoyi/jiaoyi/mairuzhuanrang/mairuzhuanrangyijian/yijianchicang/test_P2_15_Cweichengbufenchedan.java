...
public class test_P2_15_Cweichengbufenchedan {
	 ...
	 * [测试步骤]：
	 * 1、点击某品种的秒订仓单的平仓按钮
	 * 2、在委托价格编辑框输入可以委托成功不能立马成交的委托价格（如低于对手价的价格）
	 ...
	 * 3、类型显示文字买入转让，可撤量显示委托数量，价格显示委托价格
	 * 4、时间显示委托时间
	 */
	@Test
	public void testCweichengbufenchedan() {
