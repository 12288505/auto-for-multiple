package testcase.UP_China.IOS.smoke;
...
public class testIosSmoke {
	 ...
	 * 3、左右滑动查看顶部导航
	 * 期望结果：
	 * 1、首页第一页展示八个导航元素，第二页展示六个导航元素
	 * 2、首页导航可以左右滑动查看元素
	 * 3、第一页从左至右从上至下依次展示：自选，股票，渤海商品，贵金属，股林高手，选股，研究所，发现；
	 * 4、第二页从左至右从上至下依次展示：大盘指数，热门板块，金融期货，沪深基金，渤海直播，渤海交易
	 */
	@Test
